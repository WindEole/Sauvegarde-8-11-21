...
/*   Updated: 2021/06/05 15:29:28 by iderighe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	ft_printf("\n\e[0;31m SIMPLE TESTS\e[0m\n\n");

	ft_printf("\n\e[0;32m Check that the usual conversions %%s, %%p and %%d work fine\e[0m\n\n");
	...
	ft_printf("\n\n\e[0;32m Check that %%% works\e[0m\n\n");
	ft_printf("\n\e[0;36m %%%\e[0m\n\n");
	printf("fct normale : [%%%%] donne [%%]\n");
	ft_printf("ma fonction : [%%%%] donne [%%]\n");

	ft_printf("\n\n\e[0;31m LESS SIMPLE TESTS\e[0m\n\n");

	ft_printf("\n\e[0;32m Check that you can put multiple conversions and multiple arguments of the same type in a same printf\e[0m\n\n");

	ft_printf("\n\e[0;36m %%s\e[0m\n\n");
	printf("fct normale : [%%s] de Aie, J'ai mal aux dents et Tant pis donne [%s, %s, %s]\n", "Aie", "J'ai mal aux dents", "Tant pis");
	ft_printf("ma fonction : [%%s] de Aie J'ai mal aux dents et Tant pis donne [%s, %s, %s]\n", "Aie", "J'ai mal aux dents", "Tant pis");

	ft_printf("\n\e[0;36m %%p\e[0m\n\n");
	printf("fct normale : [%%p] de ptr, ptr1 et ptr2 donne [%p, %p, %p]\n", ptr, ptr1, ptr2);
	ft_printf("ma fonction : [%%p] de ptr, ptr1 et ptr2 donne [%p, %p, %p]\n", ptr, ptr1, ptr2);

	ft_printf("\n\e[0;36m %%d\e[0m\n\n");
	printf("fct normale : [%%d] de 123, -345 et 258963 donne [%d, %d, %d]\n", 123, -345, 258963);
	ft_printf("ma fonction : [%%d] de 123, -345 et 258963 donne [%d, %d, %d]\n", 123, -345, 258963);
	...
	ft_printf("\n\n\e[0;31m SLIGHTLY COMPLICATED TESTS\e[0m\n\n");
...
//	ft_printf("ma fonction : [%%02.1s] de Aie donne [%02.1s]\n\n", "Aie");
	printf("fct normale : [%%2.7s] de Aie donne [%2.7s]\n", "Aie");
	ft_printf("ma fonction : [%%2.7s] de Aie donne [%2.7s]\n\n", "Aie");
	printf("fct normale : [%%5s] de Aie donne [%5s]\n", "Aie");
	...
	printf("fct normale : [%%2s] de Aie donne [%2s]\n", "Aie");
	ft_printf("ma fonction : [%%2s] de Aie donne [%2s]\n\n", "Aie");
