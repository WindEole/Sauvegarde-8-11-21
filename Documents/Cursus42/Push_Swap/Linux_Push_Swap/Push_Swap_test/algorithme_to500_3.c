...
int	ft_define_pos_in_b_min(int xa, int *s_b, t_varlen *varlen)
{
	int	pos_in_b;
//	int	pos_in_b_value;
	int	i;
...
printf(PURPLE"pos_in_b_min on entre ici ?"RESET"\n");
	i = 0;
	pos_in_b = 0;
...
int	ft_define_pos_in_b_middle(int xa, int *s_b, t_varlen *varlen)
{
	int	i;
	int	j;
	int	pos_in_b;
...
//printf("ici ? varlen->min = %d, pos_in_b_value = %d, pos_in_b = %d\n", varlen->min, pos_in_b_value, pos_in_b);
	i = 0;
	pos_in_b = 0;
...
//	int	pos_in_b_value;
	...
	i = 0;
	pos_in_b = 0;
//	if (varlen->len_b < 2) //(xa == varlen->min || varlen->len_b < 2)
//		pos_in_b = 0;
//	pos_in_b_value = varlen->min - 1;
...
printf("On entre ici ?\n");
	...
	if (i == varlen->len_b || xa == varlen->min)
		pos_in_b = ft_define_pos_in_b_min(xa, s_b, varlen);
	else
		pos_in_b = ft_define_pos_in_b_middle(xa, s_b, varlen);
/*	{
